...
import { Avatar, Flex, IconButton, SkeletonCircle, SkeletonText, Text } from '@chakra-ui/react';

const Header = () => {
	const { loading, data } = useSelector(selectUser);

	return (
		<Flex className='border h-16' alignItems={'center'} px={2} justify={'space-between'}>
