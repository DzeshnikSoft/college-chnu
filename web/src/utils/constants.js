...
export const TEST_NEWS = [
	{
		image: 'http://college-chnu.cv.ua/pages/files/cb9d1cf0b4e0/unnamed.jpg',
		date: 'Жовтень 1, 2023',
		description:
			'З 18 вересня 2023 р. ВСП "Фаховий коледж ЧНУ" розпочинає прийом документів на ПІДГОТОВЧІ КУРСИ ом документів на ПІДГОТОВЧІ КУРСИ',
	},
	{
		image: 'http://college-chnu.cv.ua/pages/files/cb9d1cf0b4e0/unnamed.jpg',
		date: 'Жовтень 1, 2023',
	...
	},
	{
		...
		date: 'Жовтень 1, 2023',
		description:
			'З 18 вересня 2023 р. ВСП "Фаховий коледж ЧНУ" розпочинає прийом документів на ПІДГОТОВЧІ КУРСИ ',
	},
];
